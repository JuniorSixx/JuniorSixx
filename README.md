...
> WhatsApp bot integrated with Chatwoot for automated customer service at a real estate broker.
> VPS infrastructure with Docker, secure SSH, and continuous deployment for all projects.

**Junior Infrastructure Analyst** @ Ferrero · *Feb 2025 – Mar 2025*
> MikroTik, Cisco, Ubiquiti administration · Firewall rules and access policies · Preventive and corrective maintenance on servers and workstations · IT routine automation.

**Junior DevOps Engineer** @ Nutrien Soluções Agrícolas · *Feb 2024 – Feb 2025*
> Windows Server and Active Directory (IAM/RBAC) · KPI dashboards for logistics monitoring · SAP BTP integration support · Incident management via Zendesk · Bilingual technical support (EN/ES).
...
|---------|-------------|------|
| [Lain Security](https://www.linkedin.com/posts/marciojuniorr_meu-primeiro-projeto-de-ciberseguran%C3%A7a-activity-7339794926819233792-DNHS) | Personal security toolkit — recon, enumeration and offensive scripts built for CTF and lab environments. | `python` `security` `offensive` |
| [Lain Sentinel](https://www.linkedin.com/posts/marciojuniorr_cybersecurity-pentest-python-activity-7354580394215718912-bNF4) | Monitoring and threat detection tool. Alerts and automated response for suspicious activity. | `python` `monitoring` `defensive` |
| [fsociety Scanner](https://www.linkedin.com/posts/marciojuniorr_cybersecurity-pentest-python-activity-7368383455119835136-JED_) | Custom network and vulnerability scanner inspired by Mr. Robot's fsociety. Built for educational and lab use. | `python` `nmap` `scanner` |
| [NeuralCorrupt](https://github.com/JuniorSixx) | Experimental offensive security project focused on payload crafting and evasion techniques. | `security` `pentest` `research` |
| [Windows Cleaner](https://github.com/JuniorSixx) | .NET tool for automated Windows system cleanup and optimization. | `.net` `windows` `automation` |
| [PentestWrite](https://github.com/JuniorSixx/PentestWrite) | Pentest write-ups, CTF solutions, vulnerability reports, and attack methodologies. | `methodology` `ctf-writeups` `vulnerability-research` |
| [Portfolio](https://port-folio-blush-nine.vercel.app/) | Personal portfolio — cyberpunk aesthetic, i18n (PT/EN/ES). | `react` `vite` `tailwindcss` |
